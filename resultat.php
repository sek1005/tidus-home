...
echo "Merci " . $lastName . " " . $firstName . " de nous avoir contacté à propos de " . $subject . ". ";
echo "Un de nos merveilleux conseillers vous contactera soit à l’adresse " . $mail . " ou par téléphone au " . $phone  . " dans les plus brefs délais pour traiter votre demande. ";?>.</p>
           <br>
           <p class="p">Tidus vous remercie d'avoir franchi le pas ! </p>
       </div>
</main>
